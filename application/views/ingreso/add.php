...
<div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <div class="form-group">
              <input type="date" style="font-size: 12px; padding-left: 0px;" name="factura_fecha" value="<?php echo date('Y-m-d'); ?>"  class="form-control" id="factura_fecha" required />
            </div>
</div>
<div class="col-md-3">
...
<div class="input-group" style="width: 80%;">  
           <span  class="input-group-addon"><b>No. INGRESO</b></span>
              <input type="text" name="ingreso_numdoc" value="<?php echo $numero['numero']+1; ?>" class="form-control" id="ingreso_numdoc" required readonly/>
          </div> 
          <div class="input-group" style="width: 80%;">  
   ...
   <div class="input-group" >  
           ...
           <div id="elsele">
              <select name="responsable_id" class="form-control" id="responsable_id">
                ...
                {
                  $selected = ($resp['responsable_id'] == $this->input->post('responsable_id')) ? ' selected="selected"' : "";
