			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="ingreso_numdoc" value="<?php echo ($this->input->post('ingreso_numdoc') ? $this->input->post('ingreso_numdoc') : $ingreso['ingreso_numdoc']); ?>" class="form-control" id="ingreso_numdoc" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="ingreso_fecha" class="control-label">Ingreso Fecha</label>
						<div class="form-group">
							<input type="text" name="ingreso_fecha" value="<?php echo ($this->input->post('ingreso_fecha') ? $this->input->post('ingreso_fecha') : $ingreso['ingreso_fecha']); ?>" class="has-datepicker form-control" id="ingreso_fecha" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="ingreso_hora" class="control-label">Ingreso Hora</label>
						<div class="form-group">
							<input type="text" name="ingreso_hora" value="<?php echo ($this->input->post('ingreso_hora') ? $this->input->post('ingreso_hora') : $ingreso['ingreso_hora']); ?>" class="form-control" id="ingreso_hora" />
						</div>
					</div>
				</div>
			</div>
