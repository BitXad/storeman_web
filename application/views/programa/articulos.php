...
<script src="<?php echo base_url('resources/js/programa_articulos.js'); ?>"></script>
...
<div class="row" style="width: 21.59cm; font-family: Arial !important">
    <center class="no-print"><h4 style="font-family: Arial;"><b>ARTICULOS POR PROGRAMA</b></h4></center>
...
<div class="col-md-12 no-print">
    ...
    <div class="form-group">
        <select name="programa_id" id="programa_id" class="form-control" style="font-size: 8pt;" onchange="programa_articulos()">
...
<div class="col-md-5 no-print text-center">
    <center>
        ...
        <a class="btn btn-success btn-sm" onclick="programa_articulos()">
