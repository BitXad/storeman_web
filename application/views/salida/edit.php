			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="salida_fecha" value="<?php echo ($this->input->post('salida_fecha') ? $this->input->post('salida_fecha') : $salida['salida_fecha']); ?>" class="has-datepicker form-control" id="salida_fecha" />
						</div>
					</div>
					<div class="col-md-6">
