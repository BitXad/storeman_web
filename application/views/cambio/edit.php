    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Cambio Edit</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cambio_fecha" value="<?php echo ($this->input->post('cambio_fecha') ? $this->input->post('cambio_fecha') : $cambio['cambio_fecha']); ?>" class="has-datepicker form-control" id="cambio_fecha" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cambio_ufv" class="control-label">Cambio Ufv</label>
						<div class="form-group">
							<input type="text" name="cambio_ufv" value="<?php echo ($this->input->post('cambio_ufv') ? $this->input->post('cambio_ufv') : $cambio['cambio_ufv']); ?>" class="form-control" id="cambio_ufv" />
						</div>
					</div>
				</div>
			</div>
