      	...
      	<div class="box box-info">
			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ingreso_id" class="form-control">
								<option value="">- ERROR DE GESTION -</option>
								<?php 
								foreach($all_ingreso as $ingreso)
								{
									$selected = ($ingreso['ingreso_id'] == $factura['ingreso_id']) ? ' selected="selected"' : "";

									echo '<option value="'.$ingreso['ingreso_id'].'" '.$selected.'> INGRESO Nº: '.$ingreso['ingreso_numdoc'].'</option>';
								} 
								?>
							</select>
						</div>
					...
					<div class="col-md-6">
						<label for="factura_numero" class="control-label">Número</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="factura_razon" class="control-label">Razón</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="factura_importe" class="control-label">Importe</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="factura_neto" class="control-label">Neto</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="factura_creditofiscal" class="control-label">Credito fiscal</label>
						<div class="form-group">
			...
			<div class="box-footer">
            	<button type="submit" class="btn btn-success">
					<i class="fa fa-check"></i> Guardar
                            ...
                            <a href="<?php echo base_url("factura"); ?>" type="submit" class="btn btn-danger">
