            ...
            <div class="box-body">
                <table class="table table-striped" id="mitabla">
                    ...
                    <tr>
                        ...
                        <td><?php if($g['gestion_inicio'] >0){ echo date("d/m/Y", strtotime($g['gestion_inicio'])); } ?></td>
                        <td><?php if($g['gestion_fin'] >0){ echo date("d/m/Y", strtotime($g['gestion_fin'])); } ?></td>
                        <td style="background-color: <?php echo $g['estado_color']; ?>" ><?php echo $g['estado_descripcion']; ?></td>
                        <td>
