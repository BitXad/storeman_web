                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="tipousuario_descripcion" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo ($this->input->post('tipousuario_descripcion') ? $this->input->post('tipousuario_descripcion') : $tipo_usuario['tipousuario_descripcion']); ?>" class="form-control" id="tipousuario_descripcion" required/>
                        </div>
                    </div>
                    <div class="col-md-6">
